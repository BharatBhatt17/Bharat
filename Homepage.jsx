...
const Homepage = () => {
  return (
    <div
      name="home"
      className="h-screen bg-white text-black md:flex md:justify-center md:items-center md:p-20 pt-40 p-2"
    >
      <div className=" font-sans gap-8 md:gap-10 md:flex md:flex-row flex flex-col-reverse md:justify-center items-center">
        ...
        <div>
          <img
            src="https://media.discordapp.net/attachments/957284229031546993/1019459042567016468/photostudio-11-designify-modified.png?width=593&height=593"
